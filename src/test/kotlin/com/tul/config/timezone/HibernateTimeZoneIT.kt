package com.tul.config.timezone

import com.tul.IntegrationTest
import com.tul.repository.timezone.DateTimeWrapper
import com.tul.repository.timezone.DateTimeWrapperRepository
...
class HibernateTimeZoneIT {
    ...
    private fun generateSqlRequest(fieldName: String, id: Long): String =
        format("SELECT %s FROM tul_date_time_wrapper where id=%d", fieldName, id)
